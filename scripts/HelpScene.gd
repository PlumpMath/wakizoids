...
func _ready():
	...
	richTextLabel.newline()
	richTextLabel.add_text("THRUST - up arrow or W - Moves the ship forwards")
	richTextLabel.newline()
	richTextLabel.newline()
	richTextLabel.add_text("SPIN LEFT - left arrow or A - Rotates the ship left")
	richTextLabel.newline()
	richTextLabel.newline()
	richTextLabel.add_text("SPIN RIGHT - right arrow or D - Rotates the ship right")
	richTextLabel.newline()
	richTextLabel.newline()
	richTextLabel.add_text("FIRE - CTRL, TAB or RETURN - Fires at rocks or ships")
	richTextLabel.newline()
	richTextLabel.newline()
