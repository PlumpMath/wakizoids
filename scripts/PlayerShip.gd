...
onready var _brokenShip1 = load("res://scenes/brokenship1.tscn")
onready var _brokenShip2 = load("res://scenes/brokenship2.tscn")
onready var _brokenShip3 = load("res://scenes/brokenship3.tscn")
onready var _brokenShip4 = load("res://scenes/brokenship4.tscn")
